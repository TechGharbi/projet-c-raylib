...
int main(void) {
    ...
    bubbleSort(tab, n); // Sort the array using Bubble Sort
    ...
    int button1Visible = 1;
    int rectanglesVisible = 0;
    ...
    while (!WindowShouldClose()) {
        ...
        if (button1Visible) {
            ...
            DrawText("Show ", 420, 430, 20, WHITE);
        }
        ...
        if (rectanglesVisible) {
            ...
            for (int i = 0; i < rectanglesCount; ++i) {
                // Commented out the line that moves rectangles downward
                // rectangles[i].y += 1;
